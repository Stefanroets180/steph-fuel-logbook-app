...
export function FuelEfficiencyChart({ logs, carId }: FuelEfficiencyChartProps) {
    const filteredLogs = carId ? logs.filter((log) => log.car_id === carId) : logs
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Tank-to-tank fuel consumption over the last 10 fill-ups</CardDescription>
            </CardHeader>
            <CardContent>
